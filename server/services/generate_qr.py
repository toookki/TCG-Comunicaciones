...
import pyotp
import qrcode
from server.repository.executive_repository import load_executives, save_executives
...
def generate_qr_for_executives():
    ...
    for executive in executives:
        ...
        uri = totp.provisioning_uri(name=executive["email"], issuer_name="TC5G Shop")
        img = qrcode.make(uri)
